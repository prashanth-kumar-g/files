...
def action(msg):
    try:
        ...
        if command == '/Menu':
            ...
            telegram_bot.sendMessage (chat_id, str("Hi Prashanth"))
        elif command == 'BCA':
            telegram_bot.sendMessage (chat_id, str("hsfkhkchjkchjkcxhjkxchjk kjhjxchjhcjh"))
        elif command == 'Hello':
            telegram_bot.sendMessage (chat_id, str("Hello Hi Prashanth, How Can i Help You"))
        elif command == 'RVCE':
            ...
            telegram_bot.sendMessage (chat_id, str("Bye Hi Prashanth, See you again"))    
        else:
...
telegram_bot = telepot.Bot('6363502528:AAH8GIqcY16mixUOCN9jGsmv_wNt2nzlPdA')
